...
<body class="body">
	...
	<div class="mainContent">
		...
		Modules
			...
			<content id="com">
				<ol id="year1">
				<li><a href="year0.php">BSc in Management/HRM (Batch-18)</a></li>
				<li><a href="http://www.w3schools.com">BSc in Management/HRM (Batch-16)</a></li>
				<li><a href="http://www.w3schools.com">BSc in Management/HRM (Batch-17)</a></li>
		</article>
